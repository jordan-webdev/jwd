...
function jwd_scripts()
{
    ...
    // Google Font
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css?family=Playfair+Display|Poppins:400,500&display=swap');
...
// Action / Filter modifications
require $template . '/inc/functions/actions-filters.php';
